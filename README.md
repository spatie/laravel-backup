...
This package requires PHP 7.2 and Laravel 5.7.20 or higher.  
You'll find installation instructions and full documentation on https://docs.spatie.be/laravel-backup/v6.

## Using an older version of PHP / Laravel?

If you are on a PHP version below 7.2 or a Laravel version below 5.7.20 just use an older version of this package. 
