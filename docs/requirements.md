...
This backup package requires **PHP 8.4**, with the [ZIP module](http://php.net/manual/en/book.zip.php) and **Laravel 12 or higher**. It's not compatible with Windows servers.
