...
You can receive a notification when a cleanup goes wrong. Read the section on  [notifications](/docs/laravel-backup/v10/sending-notifications/overview) for more info.
